      ...
      <div className="bg-[url(./assets/bg.svg)] relative bg-cover flex flex-col gap-5 w-screen h-full pb-10 justify-center items-center ">
        ...
        <div className="relative flex flex-col justify-center items-center">
          ...
          <div className="rounded-xl bg-white px-14 pt-7 pb-10 flex flex-col justify-between gap-6 w-full max-w-96 md:max-w-2xl">
            ...
            <div className="text-lg text-gray-600 max-w-sm">
              Sign in with your data that you entered during your registration
            </div>
            {getsuccess === true && (
              <div className="bg-green-500 ml-7 h-16 w-96 rounded-2xl flex justify-center items-center top-72 text-black">
                {mess}
              </div>
            )}
            {/* {getsuccess !== true && ( */}
            {/* // <div className="bg-red-500 ml-7 h-16 w-96 rounded-2xl flex justify-center items-center top-72 text-white">  */}
            {/* {mess}  */}
             {/* </div>  */}
            {/* //   )}  */}
            <form
            ...
            >
              ...
              <span className="text-right text-blue-700 text-base">
